  ...
  tagList(
    ...
    div(
      ...
      div(
        class = "text-content",
        p(
          "Soil carbon markets are emerging to incentivise farmers for management changes that sequester atmospheric carbon.
        ...
        p(
          " We propose to create a software tool (a capital asset) for the accreditation of carbon credits claimed on the basis of changes in soil organic carbon (SOC).
             ...
             and provide recommendations for the future sampling required."
        )
      )
    )
