      ...
      if (isTruthy(rv$data_results)) {
        ...
        ggplot2::ggplot(
          ...
          ggplot2::geom_errorbar(
            data = data_2, ggplot2::aes(x = time, ymin = total - total_error, ymax = total + total_error, color = "total"),
            width = 0.2, inherit.aes = FALSE
          ) +
          ggplot2::geom_errorbar(
            data = data_2, ggplot2::aes(x = time, ymin = climate_effect - climate_error, ymax = climate_effect + climate_error, color = "climate effect"),
            width = 0.2, inherit.aes = FALSE
          ) +
          # Axis labels
